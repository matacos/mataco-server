...
function mountRoutes(app,db,schemaValidation){
    app.post("/inscripciones_final/:id/csv_notas",upload.single("csv"),async function(req,res,next){
        ...
        if(errors.length>0){
            ...
            await db.query("drop table if exists exam_grades_upload;")
            await db.query(`
            create table exam_grades_upload (
                username varchar(10),
                grade decimal
            );
            `)
            async function introduceUploadedStudents(){
                ...
                */
                ...
                let query = `
                update exam_enrolments as ce
                set grade_date = NOW(),
                    grade = cgu.grade
                from 
                    exam_grades_upload as cgu
                where
                    cgu.username = ce.student_username
                and ce.exam_id = $1
                ;
                `
            ...
            csvStream.push(null)
            let postgresStream = await db.copyFrom("COPY exam_grades_upload FROM STDIN with (format 'csv');")
            csvStream.on("end",()=>{
                console.log("=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)=)")
